...
const Sidebar = ({ onSelect }) => {
    ...
    return (
        <aside className="w-sidebar h-screen bg-[#0f172a] border-r border-white/5 flex flex-col">
            <div className="h-20 flex items-center px-24 mb-16">
                <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center mr-16 shadow-lg shadow-primary/20">
                    <LayoutDashboard className="text-white" size={20} />
                </div>
                <span className="text-[20px] font-bold text-white tracking-tight">CUP Admin</span>
            </div>
            ...
            <div className="p-16 border-t border-white/5">
                <button className="flex items-center gap-16 px-16 py-12 w-full rounded-lg text-danger/80 hover:text-danger hover:bg-danger/5 transition-all text-sm font-medium">
                    <LogOut size={20} />
                    <span>Sign Out</span>
                </button>
            </div>
